...
# Compatibility sentinels keep both the original and corrected adapter workflows
# deterministic while this construction branch is being frozen. They are not used
# by the product transformation itself.
